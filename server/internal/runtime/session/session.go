...
//
// The concrete implementation is in internal/runtime/pty: `pcd` owns each
...
// (the legacy application uses an agent ID). The runtime treats it as opaque;
// new callers can use an execution-specific ID.
