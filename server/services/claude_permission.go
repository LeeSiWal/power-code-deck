...
// InjectPending registers a request directly in the pending map and returns
...
func (b *PermissionBroker) InjectPending(req PermissionRequest) <-chan PermissionDecision {
