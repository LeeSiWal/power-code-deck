...
Claude Code, Antigravity, Codex CLI 등 AI 코딩 에이전트를 한 화면에서 실행하고 모니터링합니다.
...
> - 실행하려는 CLI(`claude` / `agy` / `codex`)는 **미리 설치**돼 있어야 합니다 → [사전 요구사항](#사전-요구사항)
...
- **멀티 에이전트** — 여러 AI 에이전트를 동시에 실행/모니터링 (Claude Code / Antigravity / Codex CLI / Custom)
...
- File Explorer
- Claude / Antigravity / Codex Launcher
...
└───────────────┬────────────────────────────────────────────┘
                ...
                ▼
┌────────────────────────────────────────────────────────────┐
│  PTY 세션: Claude Code / Antigravity / Codex CLI / Custom    │
└────────────────────────────────────────────────────────────┘
```
...
| [Antigravity](https://antigravity.google) | `curl -fsSL https://antigravity.google/cli/install.sh \| bash` (명령어: `agy`) |
...
> 어느 방식이든 실행하려는 CLI(`claude`/`agy`/`codex`)는 [사전 요구사항](#사전-요구사항)처럼 미리 설치돼 있어야 합니다.
...
- **Antigravity** — Google의 AI 코딩 에이전트 CLI (`agy`)
...
│  PTY 세션 (pcd 서버가 소유)                                   │
│  ┌───────────────────────────────────────────────────────┐  │
│  │  Claude Code / Antigravity / Codex CLI / Custom        │  │
